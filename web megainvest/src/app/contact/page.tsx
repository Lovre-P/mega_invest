...
export default function ContactPage() {
  ...
  const investmentTitle = searchParams.get('investmentTitle');
  ...
  const {
    ...
    defaultValues: {
      ...
      email: '',
      phone: '',
      investmentInterest: investmentId || '',
      message: investmentTitle
        ? `I'm interested in learning more about the "${investmentTitle}" investment opportunity.`
        : ''
    }
  });
  ...
  useEffect(() => {
    if (investmentId) {
      setValue('investmentInterest', investmentId);
    }
  ...
  }, [investmentId, investmentTitle, setValue]);
